...
public class DreamChunkGenerator implements IChunkGenerator {
    ...
    protected static final IBlockState END_STONE = WIHMBlocks.DREAM_BLOCK.getDefaultState();
    ...
    public DreamChunkGenerator(World world, long seed, BlockPos spawnPoint) {
        this.world = world;
